...
public class JwtTokenProvider {
    ...
    public String generateToken(Authentication authentication) {
        // Obtener el nombre de usuario (en este caso, el email) del objeto
        // Authentication
        ...
        // Calcular la fecha de expiración del token sumando el tiempo de expiración
        // configurado
        ...
        String token = Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS512, ConstantSecurity.JWT_SIGNATURE) // Firmar el token con el algoritmo
                                                                                    // y clave secreta
