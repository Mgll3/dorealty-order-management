...
public class CustomUsersDetailsService implements UserDetailsService {
    ...
    // Implementación del método de la interfaz UserDetailsService para cargar
    // usuarios por su correo electrónico
    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        if (user == null) {
            // Lanza una excepción indicando que el usuario no fue encontrado con el correo
            // electrónico proporcionado
            throw new UsernameNotFoundException("Usuario no encontrado con el correo electrónico: " + email);
        }

        // Crea y retorna una instancia de UserDetails con la información del usuario y
        // sus autoridades
